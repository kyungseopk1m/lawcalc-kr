...
// `src/hoffman.dataset.generated.ts`. Run via
...
const OUT = resolve(PKG_ROOT, "src/hoffman.dataset.generated.ts");
...
const banner = [
  ...
  "// Regenerate: pnpm --filter @lawcalc-kr/datasets-compensation sync:hoffman",
  "",

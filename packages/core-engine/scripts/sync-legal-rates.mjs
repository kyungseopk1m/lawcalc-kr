#!/usr/bin/env node
// Reads `data/legal-rates/v1.json` (workspace single source) and emits
// `src/legal-rates.dataset.generated.ts`. Run via `pnpm sync:legal-rates`
...
const SOURCE = resolve(REPO_ROOT, "data/legal-rates/v1.json");
const OUT = resolve(PKG_ROOT, "src/legal-rates.dataset.generated.ts");

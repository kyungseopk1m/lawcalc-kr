...
// `src/compensation/datasets/labor-rates.dataset.generated.ts`. Run via
...
const OUT = resolve(PKG_ROOT, "src/compensation/datasets/labor-rates.dataset.generated.ts");
...
const banner = [
  ...
  "// Regenerate: pnpm --filter @lawcalc-kr/core-engine sync:labor-rates",
  "",

 ...
 *   어느 원인인지는 `representationCause` 로 구분한다 (제1003조 2항 개정 이후 금액이 갈린다).
 *   **필드명이 원인 중 하나만 가리켜 오해를 부른다.** 제1004조의2 6항의 상속권 상실선고는
...
export interface HeirNode {
   ...
   *
   * 제1001조의 직계비속 대습은 세 원인 모두에서 발생한다. 그러나 제1003조 2항이

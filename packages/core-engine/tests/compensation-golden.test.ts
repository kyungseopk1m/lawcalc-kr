...
import { STANDARD_DISCLAIMER } from "../src/disclaimers";
import { computeCompensation } from "../src/compensation/compute";
import type { CompensationInput } from "../src/compensation/types";
...
const modules = import.meta.glob<GoldenCase>("./golden/compensation/*.json", {
  eager: true,
  import: "default",
});
